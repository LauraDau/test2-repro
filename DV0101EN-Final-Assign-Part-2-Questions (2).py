...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'center', 'color': '#503D36', 'fontSize': '24px'}), #Include style for title
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        summary = recession_data.groupby('Vehicle_Type').agg({
        ...
        R_chart4 = dcc.Graph(
          figure=px.bar(summary,
            ...
            title='Average Sales by Vehicle Type and Unemployment Rate During Recession'
    )
)
