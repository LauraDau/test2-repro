...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign':'centre','color':'#503D36','font-size':'24'}),#Include style for title
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'width':'80%', 'padding':'3','fontsize':'20','textAlignLast':'centre'}
        )
    ]),
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                    ...
                    names='Vehicle_Type',
                    title='Expediture Share by Vehicle Type During Recession')
        )
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        x='Year',
        y='Automobile_Sales',
        title ='Yaerly Automobile Sales Over Time'))
